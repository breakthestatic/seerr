...
import type { RadarrTestResponse, SonarrTestResponse, ReadarrTestResponse } from '@app/components/Settings/SettingsServices';
...
type ServiceTestResponse = RadarrTestResponse | SonarrTestResponse | ReadarrTestResponse
...
const OverrideRuleModal = ({
  ...
  const [testResponse, setTestResponse] = useState<ServiceTestResponse>({
    profiles: [],
    rootFolders: [],
    tags: [],
    metadataProfiles: [],
  ...
  useEffect(() => {
    ...
    if (
      ...
      getServiceInfos(readarrServices[rule?.readarrServiceId], 'readarr');
    }
  }, [
    getServiceInfos,
    radarrServices,
                        ...
                        onChange={(e) => {
                          ...
                          if (e.target.value.startsWith('radarr-')) {
                            ...
                            if (readarrServices[id]) {
                              getServiceInfos(readarrServices[id], 'readarr');
                            }
                          } else {
                            setFieldValue('radarrServiceId', null);
                            setFieldValue('sonarrServiceId', null);
